...
const database = require('./config/database'); // Usando database.js com fallback robusto
...
async function initializeServices() {
  ...
  try {
    ...
    // 3. Job scheduler removido temporariamente (arquivo não existe)
    // TODO: Implementar job-scheduler.js quando necessário
    logger.info('⚠️ Job scheduler desabilitado - focando na detecção de desconexão');
